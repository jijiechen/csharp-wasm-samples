...
int __syscall_getdents64(int i1, int i2, int i3){
	printf("__syscall_getdents64\n");
	return 0;
}

int __syscall_fadvise64_64(int i1, int i2, int i3, int i4, int i5, int i6){
	printf("__syscall_fadvise64_64\n");
	return 0;
}

int __syscall_fstat64(int i1, int i2){
	printf("__syscall_fstat64\n");
	return 0;
}

int __syscall_lstat64(int i1, int i2){
	printf("__syscall_lstat64\n");
	return 0;
}

int __syscall_stat64(int i1, int i2){
	printf("__syscall_stat64\n");
	return 0;
}

int __syscall_ftruncate64(int i1, int i2, int i3){
	printf("__syscall_ftruncate64\n");
	return 0;
}

int __syscall_getcwd(int i1, int i2){
	printf("__syscall_getcwd\n");
	return 0;
}

int __syscall_readlink(int i1, int i2, int i3){
	printf("__syscall_readlink\n");
	return 0;
}

int __syscall_unlink(int i1){
	printf("__syscall_unlink\n");
	return 0;
}

int __syscall_socket(int i1, int i2, int i3, int i4, int i5, int i6){
	printf("__syscall_socket\n");
	return 0;
}

int __syscall_connect(int i1, int i2, int i3, int i4, int i5, int i6){
	printf("__syscall_connect\n");
	return 0;
}

int __syscall_sendto(int i1, int i2, int i3, int i4, int i5, int i6){
	printf("__syscall_sendto\n");
	return 0;
}